        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-xs mt-0.5">{type === 'mobile' ? 'Drag the image inside the phone to reframe it' : "Drag the image to choose what's visible in the hero"}</p>
            </div>
          </div>
          ...
          <div className="flex-1 flex items-center justify-center p-6 bg-black/25 overflow-auto">
            {type === 'mobile' ? (
              ...
              <div className="w-full max-w-[700px] flex-shrink-0">
                ...
                >
                  {heroImage}{gradient}
                  <div className="absolute inset-0 flex items-center px-12 pt-10 pointer-events-none z-10">
          ...
          <div className="w-60 flex-shrink-0 border-l border-white/10 flex flex-col bg-[#13172a] overflow-y-auto">
            ...
            <div className="px-4 py-3 border-b border-white/8">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-0.5"><kbd className="bg-white/10 text-white text-[10px] px-1.5 py-0.5 rounded font-mono">⇧</kbd><span className="text-gray-600 text-[10px] mx-0.5">+</span><kbd className="bg-white/10 text-white text-[10px] px-1.5 py-0.5 rounded font-mono">↑↓</kbd></div>
