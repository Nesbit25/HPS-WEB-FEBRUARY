          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-xs mt-0.5">
                {type === 'mobile' ? 'Drag the image inside the phone to reframe it' : "Drag the image to choose what's visible below the nav"}
              </p>
            </div>
          </div>
                ...
                >
                  ...
                  <div className="absolute top-0 left-0 right-0 pointer-events-none z-30" style={{ height: `${DESKTOP_NAV_RATIO * 100}%` }}>
                    ...
                    <div className="relative h-full flex items-center justify-between px-5">
                      <div className="flex gap-1.5 items-center">{[0,1,2].map(i => <div key={i} className="w-3 h-3 rounded-full bg-white/20" />)}</div>
                      ...
                      <div className="bg-[#c9b896]/30 rounded-full px-2 py-0.5"><span className="text-[#c9b896] text-[7px] uppercase tracking-wider">Consult</span></div>
                    </div>
                    <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 px-5 pb-1">
                      {['About','Procedures','Gallery','Before & After','Contact'].map(tab => <span key={tab} className="text-white/30 text-[6px] uppercase tracking-wider whitespace-nowrap">{tab}</span>)}
                    </div>
                    ...
                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-full pt-0.5">
                      <div className="bg-[#c9b896] text-[#1a1f2e] text-[7px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-b whitespace-nowrap shadow-lg">&#8595; Visible hero starts here</div>
                    </div>
                  </div>
                  <div className="absolute inset-0 flex items-start px-12 pointer-events-none z-10" style={{ paddingTop: `${(DESKTOP_NAV_RATIO + 0.06) * 100}%` }}>
