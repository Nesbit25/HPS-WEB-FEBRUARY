export const noseData = {
  title: 'Nose Surgery',
  subtitle: 'Rhinoplasty and nasal procedures to enhance facial harmony and improve breathing',
  hero: 'Nose Procedure Image',
  overview: 'Rhinoplasty, commonly known as nose job or nasal reshaping, is one of the most transformative facial procedures. Whether you seek to refine your nose\'s appearance, correct breathing issues, or address injury-related concerns, Dr. Hanemann\'s expertise ensures results that complement your unique facial features while maintaining natural aesthetics.',
  procedures: [
    { 
      name: 'Primary Rhinoplasty', 
      description: 'First-time nose reshaping to refine size, shape, or proportion for improved facial balance and harmony' 
    },
    { 
      name: 'Revision Rhinoplasty', 
      description: 'Corrective surgery to address concerns from previous rhinoplasty and achieve desired results' 
    },
    { 
      name: 'Functional Rhinoplasty', 
      description: 'Surgical correction of structural issues to improve breathing and nasal airflow' 
    },
    { 
      name: 'Ethnic Rhinoplasty', 
      description: 'Specialized techniques that respect and enhance ethnic facial characteristics' 
    }
  ],
  benefits: [
    ...
    'Permanent, long-lasting transformation'
  ],
  processSteps: [
    { 
      title: 'Consultation', 
      description: 'Comprehensive evaluation of your nasal structure, discussion of goals, and digital imaging to preview potential results' 
    },
    { 
      title: 'Preparation', 
      description: 'Pre-operative instructions, medical clearance if needed, and final surgical planning' 
    },
    { 
      title: 'Surgery', 
      description: 'Procedure performed under general anesthesia, typically 2-3 hours depending on complexity' 
    },
    { 
      title: 'Recovery', 
      description: 'Initial swelling subsides within weeks, with final results visible after 12-18 months as tissues settle' 
    }
  ],
  faqs: [
    { 
...
export const faceData = {
  title: 'Face Surgery',
  subtitle: 'Facial rejuvenation procedures to restore youthful contours and radiant appearance',
  hero: 'Face Procedure Image',
  overview: 'Facial plastic surgery encompasses a range of procedures designed to address aging, enhance features, and restore a refreshed, youthful appearance. Dr. Hanemann combines surgical precision with artistic vision to deliver natural results that reflect your inner vitality while preserving your unique character.',
  procedures: [
    { 
      name: 'Facelift', 
      description: 'Comprehensive facial rejuvenation addressing sagging skin, deep folds, and loss of definition in the lower face and neck' 
    },
    { 
      name: 'Brow Lift', 
      description: 'Elevation of drooping eyebrows and smoothing of forehead wrinkles for a more alert, youthful expression' 
    },
    { 
      name: 'Eyelid Surgery', 
      description: 'Removal of excess skin and fat from upper and lower eyelids to rejuvenate the eye area' 
    },
    { 
      name: 'Neck Lift', 
      description: 'Tightening of loose neck skin and muscles to create a more defined, youthful jawline and neck contour' 
    }
  ],
  benefits: [
    'Smoother, firmer facial contours',
    'Reduction of wrinkles and fine lines',
    'More youthful, refreshed appearance',
    'Improved facial definition and structure',
  ...
  processSteps: [
    { 
      title: 'Consultation', 
      description: 'Detailed facial analysis, discussion of concerns and goals, and customized treatment planning' 
    },
    { 
      title: 'Preparation', 
      description: 'Medical evaluation, pre-operative instructions, and arrangement for post-surgery assistance' 
    },
    { 
      title: 'Surgery', 
      description: 'Procedure performed under general anesthesia or sedation, duration varies by procedure complexity' 
    },
    { 
      title: 'Recovery', 
      description: 'Gradual healing over weeks with most swelling resolving within 2-3 weeks, continued improvement for months' 
    }
  ],
  faqs: [
    { 
  ...
  recoveryTime: '2-3 weeks return to normal',
  anesthesia: 'General anesthesia or IV sedation'
};

export const breastData = {
  title: 'Breast Surgery',
  subtitle: 'Breast enhancement and reconstruction procedures tailored to your aesthetic goals',
  hero: 'Breast Procedure Image',
  overview: 'Breast surgery can enhance size, restore volume, improve shape, or reconstruct following mastectomy. Dr. Hanemann offers comprehensive breast procedures using the latest techniques to achieve beautiful, natural-looking results that complement your body proportions and meet your personal aesthetic goals.',
  procedures: [
    { 
      name: 'Breast Augmentation', 
      description: 'Enhancement of breast size and shape using implants or fat transfer for fuller, more proportionate contours' 
    },
    { 
      name: 'Breast Lift', 
      description: 'Elevation and reshaping of sagging breasts to restore a more youthful, perky position and profile' 
    },
    { 
      name: 'Breast Reduction', 
      description: 'Removal of excess breast tissue to alleviate discomfort and create a more balanced, proportionate size' 
    },
    { 
      name: 'Breast Reconstruction', 
      description: 'Rebuilding of the breast following mastectomy using implants or your own tissue for natural appearance' 
    }
  ],
  benefits: [
    'Enhanced breast size and shape',
    'Improved body proportions and symmetry',
    'Restored volume after pregnancy or weight loss',
    'Relief from physical discomfort (reduction)',
  ...
  processSteps: [
    { 
      title: 'Consultation', 
      description: 'Discussion of goals, examination, sizing session, and review of implant options or surgical techniques' 
    },
    { 
      title: 'Preparation', 
      description: 'Medical clearance, pre-operative instructions, and final confirmation of surgical plan and implant selection' 
    },
    { 
      title: 'Surgery', 
      description: 'Procedure performed under general anesthesia, typically 1-3 hours depending on the complexity' 
    },
    { 
      title: 'Recovery', 
      description: 'Gradual return to activities over 4-6 weeks, with final results visible after swelling resolves completely' 
    }
  ],
  faqs: [
    { 
...
export const bodyData = {
  title: 'Body Surgery',
  subtitle: 'Body contouring procedures to sculpt, refine, and transform your physique',
  hero: 'Body Procedure Image',
  overview: 'Body contouring surgery removes excess skin and fat, tightens underlying tissues, and sculpts your physique to create a more toned, proportionate appearance. Whether you\'ve experienced weight loss, pregnancy, or simply want to enhance your natural contours, Dr. Hanemann offers comprehensive solutions tailored to your body and goals.',
  procedures: [
    { 
      name: 'Liposuction', 
      description: 'Targeted removal of stubborn fat deposits to sculpt and refine body contours in multiple areas' 
    },
    { 
      name: 'Tummy Tuck', 
      description: 'Removal of excess abdominal skin and tightening of muscles for a flatter, firmer midsection' 
    },
    { 
      name: 'Body Lift', 
      description: 'Comprehensive contouring of multiple body areas, ideal after significant weight loss' 
    },
    { 
      name: 'Arm Lift', 
      description: 'Removal of excess skin and fat from upper arms to create smoother, more toned contours' 
    }
  ],
  benefits: [
    'Improved body proportions and contours',
    'Removal of stubborn fat and excess skin',
  ...
  processSteps: [
    { 
      title: 'Consultation', 
      description: 'Comprehensive body assessment, discussion of problem areas and goals, and customized treatment planning' 
    },
    { 
      title: 'Preparation', 
      description: 'Medical evaluation, optimization of health and weight stability, and pre-operative instructions' 
    },
    { 
      title: 'Surgery', 
      description: 'Procedure performed under general anesthesia, duration varies based on extent of treatment areas' 
    },
    { 
      title: 'Recovery', 
      description: 'Gradual return to activities over 4-8 weeks, with continued improvement as swelling resolves and tissues settle' 
    }
  ],
  faqs: [
    { 
