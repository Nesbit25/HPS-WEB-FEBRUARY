          ...
          <div className="grid lg:grid-cols-5 gap-12 items-center">
            <div className="hidden lg:block lg:col-span-2 space-y-8">
              <div>
                ...
                <button onClick={() => onNavigate('Procedures')} className="bg-transparent border-2 border-secondary text-secondary hover:bg-secondary hover:text-white px-8 py-3 text-sm uppercase tracking-[0.2em] transition-all duration-300">
                  View All Services
                </button>
              </div>
            </div>
                    ...
                    return (
                      <div key={`${service.title}-${index}`} className="flex-shrink-0 w-80 md:w-96 snap-center group relative h-full">
                        <div className="absolute inset-0 overflow-hidden bg-gray-400">
                          {resolvedSrc && (
                            <img src={resolvedSrc} alt={service.title} className="w-full h-full object-cover object-center group-hover:scale-110 transition-transform duration-700" onError={() => { setFailedServiceImages(prev => new Set([...prev, service.title])); }} />
                          )}
                        </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            ...
            <img
              src="/images/about/dr-hanemann-reading.jpg"
              alt="Dr. Hanemann"
      ...
      <section className="py-24 bg-primary text-white">
        <div className="container mx-auto px-6">
          <div className="flex justify-between items-end mb-12">
            ...
            <button onClick={() => onNavigate('Gallery')} className="hidden md:inline-flex items-center gap-2 text-secondary hover:text-white transition-colors">
