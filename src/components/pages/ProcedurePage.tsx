...
export function ProcedurePage({ data, procedureType, onNavigate }: ProcedurePageProps) {
  ...
  const loadFeaturedGallery = async () => {
    try {
      ...
      // Fetch all cases from server (including flag data for base items)
      ...
      console.log(`[${procedureType}] All database cases:`, customCases);
      ...
      const mergedBaseItems = baseGalleryItems.map(baseItem => {
        ...
        if (dbCase) {
          console.log(`[${procedureType}] Merging base item ${baseItem.id} with DB flags:`, dbCase);
      ...
      console.log(`[${procedureType}] All items after merging flags:`, allItems);
      
      // Filter for featured on this procedure page
      const featuredCases = allItems.filter((c: any) => c[featureFlag]);
      
      console.log(`[${procedureType}] Featured cases (${featureFlag}):`, featuredCases);
      
      // Load images for featured cases
      ...
      console.log(`[${procedureType}] Featured gallery with images:`, updatedItems);
